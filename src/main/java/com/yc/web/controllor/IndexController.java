...
public class IndexController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/toWithdraw.action")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/toChongzhi.action")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/toUserFund.action")
	public String toUserFund() {
		return "userFund";
	}
	 ...
	 *                                   3)如果需要返回JSON，XML或自定义mediaType内容到页面，
	 ...
	 *                                   则需要用 @Controller配合视图解析器InternalResourceViewResolver才行
	 * 
	 *                                   2)如果需要返回JSON，XML或自定义mediaType内容到页面显示，
	 *                                   需要在对应的方法上加上@ResponseBody注解。
	 * 
	 */
}
